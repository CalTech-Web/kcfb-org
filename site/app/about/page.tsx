        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <blockquote className="border-l-4 border-gray-300 pl-5 mb-6 italic text-lg text-gray-700 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {officers.map((officer) => (
              ...
              >
                <div className="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold bg-[#1a1a1a]">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {boardMembers.map((member) => (
              ...
              >
                <div className="w-10 h-10 rounded-full mx-auto mb-2 flex items-center justify-center text-gray-700 text-sm font-bold bg-gray-200">
                  {member.charAt(0)}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 text-center">
              <div className="w-20 h-20 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold bg-[#1a1a1a]">
                TF
              </div>
