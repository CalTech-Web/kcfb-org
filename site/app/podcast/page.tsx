        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 hover:shadow-md hover:border-[#1E5C2B]/20 transition-all group text-center"
            >
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform"
                style={{ backgroundColor: "#1E5C2B" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="#D4A843"><path d="M18.87 19.66c-.57.85-1.2 1.7-2.15 1.72-.94.02-1.24-.56-2.31-.56-1.08 0-1.41.54-2.31.58-.92.04-1.63-.92-2.2-1.77C8.55 17.42 7.7 14.25 9.08 12.1c.69-1.07 1.91-1.74 3.24-1.76 .91-.02 1.77.61 2.32.61.56 0 1.6-.76 2.7-.65.46.02 1.75.19 2.58 1.4-.07.04-1.54.9-1.52 2.68.02 2.13 1.87 2.84 1.89 2.85-.02.05-.3 1.02-.92 2.03zM14.5 5.82c.58-.7.97-1.67.87-2.64-.84.03-1.85.56-2.46 1.27-.54.63-1.01 1.63-.88 2.59.93.07 1.88-.47 2.47-1.22z"/></svg>
              </div>
            ...
            >
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform"
                style={{ backgroundColor: "#1E5C2B" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="#D4A843"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>
              </div>
              <div className="font-bold text-lg mb-2 text-gray-900">
                Spotify
              </div>
            ...
            >
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform"
                style={{ backgroundColor: "#1E5C2B" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="#D4A843"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </div>
              <div className="font-bold text-lg mb-2 text-gray-900">
                YouTube
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3">
            {episodes.map((ep) => (
              <div
                key={ep.number}
                className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:border-[#1E5C2B]/30 transition-all flex gap-4 p-4"
              >
                {/* Episode number circle */}
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm"
                  style={{ backgroundColor: "#1E5C2B", color: "#D4A843" }}
                >
                  {ep.number}
                </div>
                {/* Content */}
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mb-2">{ep.date}</p>
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {ep.apple && (
                      ...
                      >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.87 19.66c-.57.85-1.2 1.7-2.15 1.72-.94.02-1.24-.56-2.31-.56-1.08 0-1.41.54-2.31.58-.92.04-1.63-.92-2.2-1.77C8.55 17.42 7.7 14.25 9.08 12.1c.69-1.07 1.91-1.74 3.24-1.76 .91-.02 1.77.61 2.32.61.56 0 1.6-.76 2.7-.65.46.02 1.75.19 2.58 1.4-.07.04-1.54.9-1.52 2.68.02 2.13 1.87 2.84 1.89 2.85-.02.05-.3 1.02-.92 2.03zM14.5 5.82c.58-.7.97-1.67.87-2.64-.84.03-1.85.56-2.46 1.27-.54.63-1.01 1.63-.88 2.59.93.07 1.88-.47 2.47-1.22z"/></svg>
                        Apple
                      </a>
                    )}
                    {ep.youtube && (
