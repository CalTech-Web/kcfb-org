...
// Add new issues to the TOP of this array.
// The first entry is always the featured/highlighted issue.
// Previous issues automatically move to the grid below.
const issues = [
  {
    title: "March 2026",
...
const archiveYears = [
  { year: "2025", url: "/farm-life/2025/" },
  { year: "2024", url: "/farm-life/2024/" },
  { year: "2023", url: "/farm-life/2023/" },
  { year: "2022", url: "/farm-life/2022/" },
  { year: "2021", url: "/farm-life/2021/" },
  { year: "2020", url: "/farm-life/2020/" },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <div className="bg-gray-50 rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <Image
                  src={featuredIssue.image}
                  alt={`Farm Life ${featuredIssue.title} cover`}
                  width={600}
                  height={800}
            ...
            <div className="lg:sticky lg:top-8">
              <div className="inline-block px-3 py-1 rounded-full text-xs font-bold mb-4 bg-[#A0422A]/10 text-[#A0422A]">
                {featuredIssue.title.toUpperCase()}
              </div>
              <h2 className="text-3xl font-bold mb-4 text-gray-900">
                Farm Life - {featuredIssue.title}
              </h2>
