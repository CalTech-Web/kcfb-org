    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                <h3 className="font-bold text-xl mb-6" style={{ color: "#1E5C2B" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                >
                  <item.icon size={24} style={{ color: "#1E5C2B" }} />
                </div>
      ...
      <section className="py-14 px-4" style={{ backgroundColor: "#1E5C2B" }}>
        <div className="max-w-3xl mx-auto text-center text-white">
          <h2 className="text-2xl font-bold mb-4">Apply for the KCFB Scholarship</h2>
